...
public class RSAEncrypt {
    ...
    private static final String DEFAULT_PUBLIC_KEY=
            "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQC1ZIPEQHPHNiE4pB/4m+PPacXV" + "\r" +
                    "TXcQ2gytTPNOfwcwCG477uaNG8ByB1tpDZ2bGur/nf23lMiBu83J9K/c6ZO9AIwi" + "\r" +
                    "s1iw6uh63PReTQPY65PrXF+x6zVrTj4WpQ8bXHar6CALyWG7UyzY28pv/V3cJDci" + "\r" +
                    "aqN+N6Ne5eSL2gi0RwIDAQAB" + "\r";
...
//            byte[] plainText = rsaEncrypt.decrypt(rsaEncrypt.getPrivateKey(), cipher);
            ...
            System.out.println(new String(RSAEncrypt.byteArrayToString(cipher)));
